...
while True:
    query_country = simpledialog.askstring('Country', 'Type the name of a country: (quit-for quit)')
    query_country = query_country.capitalize()
    if query_country.lower() == "quit":
        break
    if query_country in the_world:
        ...
        the_world[query_country] = new_city.capitalize()
